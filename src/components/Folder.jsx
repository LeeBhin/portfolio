        ...
        <Draggable handle='.handle'>
            <Resizable className='folder'
                ...
                onResizeStop={(e, direction, ref, d) => {
                    console.log('Resized to', ref.style.width, ref.style.height);
                }}
                handleStyles={{
                    top: { cursor: 'ns-resize', height: '10px', background: 'none' },
                    right: { cursor: 'ew-resize', width: '10px', background: 'none' },
                    bottom: { cursor: 'ns-resize', height: '10px', background: 'none' },
                    left: { cursor: 'ew-resize', height: '10px', background: 'none' }
                }}
            >
                <div className="folderWrap">
                    <div className="handle folderHeader">
