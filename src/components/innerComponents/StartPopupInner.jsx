...
function StartPopupInner() {
    ...
    const skillName = ['HTML', 'CSS', 'JavaScript', 'Jquery', 'Python', 'React', 'Vue', 'Next.js', 'Java', 'JSP', 'OracleSQL', 'Firebase', 'Socket.io', 'Express.js', 'Github', 'Visual Studio Code', 'Brackets', 'IntelliJ IDEA', 'Photoshop', 'PowerPoint', 'Excel', 'Word', 'Access', '한컴오피스 한글']
    const photoIcon = ['', '', '', '', '', '']
